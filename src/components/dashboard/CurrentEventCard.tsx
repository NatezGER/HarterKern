...
export function CurrentEventCard() {
  ...
  return (
    <AnimatedCard data-event-theme={denmark ? "denmark" : "default"} className={cn("relative overflow-hidden bg-gradient-to-br from-white/[0.06] to-transparent p-6 sm:p-8", denmark && "denmark-event-highlight")} hover={false}>
      <div className="absolute right-0 top-0 h-full w-1/3 bg-gold-400/[0.04] [clip-path:polygon(55%_0,100%_0,100%_100%,0_100%)]" />
      <div className="relative">
        {denmark && <p className="mb-4 text-xs font-black uppercase tracking-[0.2em] text-amber-200">Dänemark · Championship {event.trophyCompetitionYear}</p>}
