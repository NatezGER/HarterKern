...
export function CurrentEventCard() {
  ...
  return (
    <AnimatedCard data-event-theme={denmark ? "denmark" : "default"} className={cn("relative overflow-hidden bg-gradient-to-br from-white/[0.06] to-transparent p-6 sm:p-8", denmark && "denmark-archive-card denmark-current-event")} hover={false}>
      ...
      <div className="relative">
        {denmark && <p className="denmark-championship-label mb-4">Dänemark · Championship {event.trophyCompetitionYear ?? ""}</p>}
