  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 h-full w-1/2 opacity-60">
        <div className="context-hero-beam absolute bottom-[-20%] right-[5%] h-[115%] w-24 rotate-[22deg] blur-[1px]" />
      ...
      <div className="relative py-3 sm:py-5">
          ...
          >
            ...
            <p className="context-gradient-text mt-4 font-display text-[clamp(1.75rem,5vw,4rem)] font-black uppercase italic leading-none tracking-[-0.03em]">
              2 Fast 2 Drink
            </p>
