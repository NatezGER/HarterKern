...
describe("TrophyCabinet", () => {
  it("separates trophies from badges and collapses after two mobile entries", () => {
    ...
    expect(markup).toContain("min-[375px]:h-36");
    expect(markup).toContain("sm:h-64");
    expect(markup).toContain("lg:h-72");
    expect(markup).toContain("min-h-[16rem]");
    expect(markup).toContain("sm:min-h-[27rem]");
  ...
  it("renders a historical achievement as a named trophy without an event link", () => {
    ...
    expect(markup).not.toContain("Historische Trophäe");
    expect(markup).not.toContain("Historischer Meilenstein");
    expect(markup).not.toContain("01.01.2024");
