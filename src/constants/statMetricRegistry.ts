...
export const statisticMetricRegistry: StatisticMetricDefinition[] = [
  ...
  { key: "best-five-window", title: "Bestes 5er-Fenster", description: "Fünf gültige direkte Event-Attempts", format: "time", direction: "asc", minimumSample: 5, group: "performance", scopes: all, compareBlock: "speed", scoreable: true },
  ...
  { key: "consistency", title: "Konstanz", description: "Variationskoeffizient; niedriger ist konstanter", format: "percent", direction: "asc", minimumSample: 5, group: "consistency", scopes: all, compareBlock: "consistency", scoreable: true },
  ...
  { key: "event-participations", title: "Eventteilnahmen", description: "Events mit mindestens einem eigenen Attempt", format: "count", direction: "desc", minimumSample: 1, group: "volume", scopes: all, compareBlock: "volume", scoreable: true },
  ...
  { key: "fast-starter", title: "Fast Starter", description: "Median des Abstands von Attempt 1 zur finalen Event-PB", format: "time", direction: "asc", minimumSample: 3, group: "event", scopes: all, compareBlock: "clutch", scoreable: true },
  { key: "late-bloomer", title: "Late Bloomer", description: "Finale PB erstmals nach der Eventhälfte", format: "percent", direction: "desc", minimumSample: 3, group: "event", scopes: all, compareBlock: "clutch", scoreable: true },
  { key: "clutch", title: "Clutch", description: "Eine der letzten zwei Zeiten setzt eine strikt neue finale PB", format: "percent", direction: "desc", minimumSample: 3, group: "event", scopes: all, compareBlock: "clutch", scoreable: true },
  { key: "one-shot", title: "One Shot Wonder", description: "Attempt 1 bleibt persönliche Event-PB", format: "percent", direction: "desc", minimumSample: 3, group: "event", scopes: all, compareBlock: "clutch", scoreable: true },
  { key: "lead-time", title: "Führungszeit", description: "Qualifizierte Event-Führungszeit", format: "duration", direction: "desc", minimumSample: 1, group: "event", scopes: all },
  { key: "event-breaks", title: "Event-Bestzeiten gebrochen", description: "Strikt schnellere Eventzeiten", format: "count", direction: "desc", minimumSample: 1, group: "event", scopes: all },
  { key: "takeovers", title: "Lead Takeovers", description: "Direkte Führungsübernahmen", format: "count", direction: "desc", minimumSample: 1, group: "event", scopes: all },
  ...
  { key: "rare-hunter", title: "Rare Hunter", description: "Eigene Endungen mit höchstens drei regulären Spielern", format: "count", direction: "desc", minimumSample: 1, group: "bingo", scopes: career, compareBlock: "bingo", scoreable: true },
  ...
  { key: "chaos-magnet", title: "Chaos-Magnet", description: "Beteiligung an direkten Führungswechseln", format: "count", direction: "desc", minimumSample: 1, group: "rivalry", scopes: career, compareBlock: "rivalry", contextOnly: true },
